...
function AccountPage() {
  ...
  const temporaryToast = async () => {
    ...
    await setTimeout(() => {
      document.getElementById("toast-change-password").classList.add("hidden");
    }, 3000);
  };
  ...
  const { data: availableManagers, status: statusAvailableManagers } = useQuery(
    "availableManagers",
  ...
  if (status === "success") {
    return (
      ...
      >
            ...
            >
              <div className="form-control">
                ...
                <input
                  ...
                  {...registerPw("oldPassword", { required: true })}
                />
              </div>
              <div className="form-control">
                <label className="label">
              ...
              <div className="form-control ">
                <div
                  className="alert alert-error shadow-lg hidden flex-row justify-start w-full"
                  role="alert"
                >
                  <svg
        ...
        <div
          id="toast-change-password"
          className="toast toast-end toast-middle hidden"
        >
          ...
          <div className="modal-box">
            ...
            <div className="modal-action">
              <label htmlFor="modal-delete-account">
                <button
                  className="btn btn-error modal-open"
            ...
            <div className="modal">
              <div className="modal-box relative">
                ...
                <form
                  ...
                  onSubmit={handleSubmitUpgrade(handleUpgradeAccount)}
                >
                  <div className="form-control mb-3">
                    <p className="text-lg">
                      {" "}
                      Price: <span className=" text-red-500">5$/month</span>
                    </p>
                  </div>
                  <div className="form-control">
                    <input
                  ...
                  <div className="form-control">
                    <div className="flex items-center mb-3">
                      <input
                        ...
                        checked
                        {...registerUpgrade("type", { required: true })}
                      />
                  ...
                  <div className="modal-action">
                    <label htmlFor="modal-upgrade-account">
                      <button
                        className="btn btn-primary modal-open"
                        type="submit"
                      >
                        Upgrade
                      </button>
          ...
          <>
            ...
            <div className="modal">
              <div className="modal-box relative">
                ...
                <form
                  className="flex flex-col"
                  onSubmit={handleSubmitManager(handlechooseManager)}
                >
                  <div className="form-control mb-2">
                    <select
                      className="select select-bordered w-full max-w-xs"
                      defaultValue=""
                      {...registerManager("managerId", { required: true })}
                    >
